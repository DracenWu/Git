...
import json
import pickle
root = 'E:/py_TensorFlow/refinenet-image-segmentation-master/data/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/SegmentationClass/'
map_dict=dict()
...
for file in os.listdir(root):
    ...
    if len(map_dict)==22:
        break
with open('data/color_map','wb+') as f:
